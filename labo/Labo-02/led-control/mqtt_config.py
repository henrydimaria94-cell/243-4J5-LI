...
MQTT_CONFIG = {
    ...
    "username": "esp_user",
    "password": "Dumont@1994",  # ⚠️ Remplacez par votre mot de passe réel

    # Device ID de votre ESP32
    # Format: esp32-XXXXXX (les 6 derniers caractères de l'adresse MAC)
    "device_id": "esp32-henridumont",  # ⚠️ OBLIGATOIRE: Remplacez par l'ID réel affiché par l'ESP32
}
